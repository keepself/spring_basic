...
private final OrderService orderService;
    ...
    public ResponseEntity<CommonResponse> orderCreate(@RequestBody List<OrderRequest> orderRequests){
        Ordering odering = orderService.create(orderRequests);
    ...
    public ResponseEntity<CommonResponse> orderCancel(@PathVariable Long id){
        ...
        return new ResponseEntity<>(new CommonResponse(HttpStatus.OK,"order successfully canceled",odering.getId()),HttpStatus.OK);
